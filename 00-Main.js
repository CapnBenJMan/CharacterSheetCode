...
function version(i) {
	//version update
	const v1 = "v3.6.1" //sheet/code version
	var rangeLHT = i.source.getRange("Legal and How-to!M4")
	var rangeLBV = i.source.getRange('Legal and How-to!AC5')
	const v2 = 34 //compatible library version. CHECK WHENEVER YOU UPDATE AND MAKE SURE THIS NUMBER IS 1 + WHATEVER THE LATEST VERSION WHEN YOU DEPLOY A NEW VERSION
